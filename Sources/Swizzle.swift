...
// SWIFT BUG: constraints on assocated types declaration.
where Self.AssociatedVector2.Component == Self.Component {
...
where
Self.AssociatedVector2.Component == Self.Component,
Self.AssociatedVector3.Component == Self.Component {
