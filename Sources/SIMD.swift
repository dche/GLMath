...
extension Float {
    ...
    public func pow(_ exp: Float) -> Float { return simd.pow(self, exp) }
...
extension Double {
    ...
    public func pow(_ exp: Double) -> Double { return simd.pow(self, exp) }
...
extension double2x2: Vector2, GenericSquareMatrix {
    ...
    public typealias Element = dvec2
    public typealias Dim = Dimension2
...
extension double2x3: Vector2, GenericMatrix {
    ...
    public typealias Element = dvec3
    public typealias Dim = Dimension2
    public typealias NumberType = Double
}
...
extension double2x4: Vector2, GenericMatrix {
    ...
    public typealias Element = dvec4
    public typealias Dim = Dimension2
    public typealias NumberType = Double
}
